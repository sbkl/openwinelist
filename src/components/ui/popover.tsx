...
function PopoverAnchor({
  ...
  const anchorRef = useContext(PopoverAnchorContext);
  const refCallback = useCallback(
    (node: HTMLDivElement | null) => {
      if (anchorRef) {
        (anchorRef as React.MutableRefObject<HTMLElement | null>).current =
          node;
      }
    },
    [anchorRef],
  ...
  if (asChild && React.isValidElement(children)) {
    return React.cloneElement(
      children as React.ReactElement<{ ref?: unknown }>,
      {
        ref: refCallback,
        ...props,
      },
...
function PopoverContent({
  ...
  const contextAnchor = useContext(PopoverAnchorContext);
